                ...
                utils.setUpApp(function () {
                    utils.createCtlTree(function (ctl) {
                        renderer.getTreeHtml(ctl, null, null, function (html) {
                            var regex = /<div lazo-cmp-name="name[0-9]+" lazo-cmp-id="[0-9]+"><div lazo-view-id="view[0-9]+" class="unbound"><div lazo-cmp-container="foo"><div lazo-cmp-name="name[0-9]+" lazo-cmp-id="[0-9]+"><div lazo-view-id="view[0-9]+" class="unbound">I am a template!<\/div><\/div><div lazo-cmp-name="name[0-9]+" lazo-cmp-id="[0-9]+"><div lazo-view-id="view[0-9]+" class="unbound">I am a template!<\/div><\/div><\/div><\/div><\/div>/;
