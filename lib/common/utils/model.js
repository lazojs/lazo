                ...
                if (modelList[gid]) {
                    ...
                    m.fetch({
                        ...
                        error: function (model, response, opts) {
                            ...
                            LAZO.logger.error(['common.utils.model.process'], 'Error loading model %s %j', modelName, response);
                    ...
                    if (options.persist == false) {
                        ...
                        m.save({}, {
                            ...
                            error: function (model, xhr, opts) {
                                LAZO.logger.error(['common.utils.model.createModel'], 'Error creating model %s %j', name, xhr);
                                if (options.error) {
