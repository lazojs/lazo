define(['underscore', 'utils/loader', 'context'], function (_, loader, Context) {
    ...
    return {
        ...
        process: function (path, params, options) {
            var self = this;
            var cmpDef = options.def;
            var ctx = new Context(params);
            var hasLayoutChanged = cmpDef.layout && cmpDef.layout !== params.layout;
                            ...
                            success: function () {
                                return self.getAssets(cmpDef.name, ctx, {
                                    success: function (assets) {
                                        ...
                                        options.success(ctl, ctx, params, assets, cmpDef, options);
                                    },
                                    error: onError
                                });
                            },
