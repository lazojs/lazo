define(['resolver/file', 'underscore', 'text', 'lazoView', 'context', 'utils/loader', 'lazoCollectionView', 'async', 'assets'],
    function (file, _, text, LazoView, Context, loader, LazoCollectionView, async, LazoAssets) {
