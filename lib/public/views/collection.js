define(['lazoViewMixin', 'flexo', 'underscore', 'resolver/main', 'l!viewManager'],
    function (mixin, flexo, _, resolver, viewManager) {
    ...
    return flexo.CollectionView.extend(_.extend({
        ...
        attachItemViews: function (callback) {
                    ...
                    if (collections[i].length) {
                        collections[i].each(function (model) {
                            ...
                            if (self._itemViews[model.cid]) {
                                viewManager.attachView(self._itemViews[model.cid], $el[0]);
                                isDone();
                            } else {
                                self.getItemView(model, collections[i], function (err, View) {
                        ...
                        if (collections[i].emptyView) {
                            viewManager.attachView(collections[i].emptyView, $el[0]);
                            isDone();
                        } else {
                            self.getEmptyView(collections[i], function (err, View) {
