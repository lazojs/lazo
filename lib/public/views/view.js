    ...
    return _.extend({
        ...
        render: function (options) {
            ...
            renderer.getTreeHtml(this.ctl, this.cid, 'view', function (html) {
                ...
                viewManager.attachViews(self.ctl, function () {});
            });
        ...
        attach: function (el, options) {
            ...
            this.$el.removeClass('unbound').addClass('bound');
        ...
        _getAttributes: function () {
            ...
            if (this._uiStates) {
                attrs.class += _.reduce(this._uiStates, function (memo, state) {
                    return memo + (memo.length ? ' ' : '') + state;
                }, attrs.class);
            }

            if (LAZO.app.isServer) {
                attrs.class += (attrs.class.length ? ' ' : '' + 'unbound');
            }
