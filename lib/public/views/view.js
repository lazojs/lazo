    ...
    return _.extend({
        ...
        resolveChild: function (viewName, options) {
            ...
            this.loadChild(viewNameVal, {
                error: options.error,
                success: function (View) {
                    self.childViewInstances = self.childViewInstances || {};
                    var view = self.childViewInstances[viewName] = new View(self.getChildOptions({
                        name: viewNameVal
                    }));
                    options.success(view);
                }
        ...
        _getAttributes: function () {
            ...
            attrs.class += (attrs.class.length ? ' ' : '' + self.getStateClass('detached'));
