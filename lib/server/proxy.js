        ...
        sync: function (method, options) {
            ...
            findSyncer(model, {
                success: function (Syncher) {
                    ...
                    LAZO.logger.debug(['server.proxy.sync'], 'Calling CRUD syncher...', model.name, opts);
        ...
        callSyncher: function (fname, args, options) {
            ...
            findSyncer(model, {
                success: function (Syncher) {
                    ...
                    LAZO.logger.debug(['server.proxy.callSyncher'], 'Calling NON-CRUD syncher...', fname, args, options);
