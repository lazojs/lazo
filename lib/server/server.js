define([
    ...
    'forbidden',
    'appSetup'
], function (appHandler, assetsHandler, cls, cluster, fs, hapi, path, resolver, safeHandler, streamHandler, tunnelHandler, _, forbidden, appSetup) {
    ...
    return {
        ...
        _create: function (callback) {
            ...
            appSetup(hapi, this.pack, this._servers, function (err) {
                if (err) {
                    console.log('lazo: ' + err.message);
                }
