define([
    ...
    return {
        ...
        _extensions: function () {
            ...
            this.server.ext('onRequest', lazoNs.bind(onRequest, lazoNs.createContext()));
            this.sslServer && this.sslServer.ext('onRequest', lazoNs.bind(onRequest, lazoNs.createContext()));
