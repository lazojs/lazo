    ...
    return {
        ...
        _buildReply: function (ctl, ctx, appAssets, cmpDef, route, options) {
            ...
            (function (self) {
                ...
                if (isDevelopment) {
                    ctx._rootCtx.dependencies.css = bundle.createCSSLinks(LAZO.app.css.slice(0).concat(ctx._rootCtx.dependencies.css));
                    ctx._rootCtx.dependencies.imports = bundle.createImportLinks(LAZO.app.imports.slice(0).concat(ctx._rootCtx.dependencies.imports));
                ...
                bundle.response(route, ctl.ctx.location.pathname, {
                    success: function (modules) {
                        if (modules) {
                            ...
                            rootCtx.dependencies.css = bundle.createCSSLinks(LAZO.app.css.slice(0).concat(ctx._rootCtx.dependencies.css));
                            rootCtx.dependencies.imports = bundle.createImportLinks(LAZO.app.imports.slice(0).concat(ctx._rootCtx.dependencies.imports));
                        }
