                ...
                bundle.response(route, ctl.ctx.location.pathname, {
                    success: function (modules) {
                        if (modules) {
                            ...
                            rootCtx.dependencies.css = bundle._createCSSLinks(LAZO.app.css.slice(0).concat(ctx._rootCtx.dependencies.css));
                            rootCtx.dependencies.imports = bundle._createImportLinks(LAZO.app.imports.slice(0).concat(ctx._rootCtx.dependencies.imports));
                        }
