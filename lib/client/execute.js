define(
    [
        ...
        'renderer', 'context', 'utils/cmpProcessor'
    ],
    function ($, _, rehydrate, state, doc, prime, renderer, Context, cmpProcessor) {
...
console.log('EXECUTE!!!');
        ...
        var cmpDef = cmpProcessor.getDef(LAZO.routes[eventData.route], LAZO.defaultLayout);
        var options = {
        ...
        cmpProcessor.process(eventData.path, eventData.parameters, {
            options: options,
            def: cmpDef,
            error: function (err) {
console.log(err);
            ...
            success: function (ctl, ctx, params, assets, cmpDef) {
                ...
                // TODO: how dow we handle layouts?
