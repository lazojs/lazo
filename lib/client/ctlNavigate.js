define(['jquery', 'underscore', 'context'], function ($, _, Context) {
    ...
    return function (callingCtl, cmpName, action, params, crumb, options) {
        ...
        LAZO.logger.debug(['client.cltNavigate'], 'Begin navigation...', cmpName, action, params);
        ...
        $.ajax({
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                LAZO.logger.debug(['client.cltNavigate'], 'Navigation error', cmpName, action, params, textStatus, errorThrown);
