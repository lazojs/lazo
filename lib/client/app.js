define(['jquery', 'underscore', 'backbone', 'lazoCtl', 'renderer', 'async', 'hermes', 'rehydrate/main', 'execute', 'lib/client/state', 'lib/client/prime'],
    function ($, _, Backbone, LazoCtl, renderer, async, hermes, rehydrate, execute, state, prime) {
