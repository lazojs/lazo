    ...
    var Proxy = Base.extend({
        ...
        sync: function (method, options) {
            ...
            options.error = function (jqXHR) {
                LAZO.logger.debug(['client.proxy.sync'], 'Call to CRUD syncher failed', this.name, method, jqXHR);
            ...
            options.success = function (resp, textStatus, jqXHR) {
                LAZO.logger.debug(['client.proxy.sync'], 'Call to CRUD syncher succeed', this.name, method, resp, textStatus);
        ...
        callSyncher: function (fname, args, options) {
            ...
            options.error = function (jqXHR, textStatus, errorThrown) {
                LAZO.logger.debug(['client.proxy.sync'], 'Call to NON-CRUD syncher failed', this.name, fname, args, textStatus, errorThrown);
            ...
            options.success = function (resp, textStatus, jqXHR) {
                ...
                LAZO.logger.debug(['client.proxy.sync'], 'Call to NON-CRUD syncher succeed', this.name, fname, args, resp, textStatus);
